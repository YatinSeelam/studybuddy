...
const Hero = () => {
    return (<section className="pt-24 pb-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-background to-primary-50">
        ...
        <div className="text-center space-y-8">
          ...
          <div className="hero-animation flex items-center justify-center space-x-3 text-textSecondary">
            <div className="flex items-center">
              <lucide_react_1.CheckCircle className="w-5 h-5 text-primary-500 mr-2"/>
              <div className="flex items-center space-x-1">
                <lucide_react_1.Heart className="w-4 h-4 text-error fill-current"/>
                <span>Loved by</span>
              </div>
            </div>
              ...
              <div className="bg-white rounded-2xl shadow-2xl p-8 border border-gray-200">
                ...
                <div className="mt-6 p-4 bg-accent-50 rounded-lg border border-accent-200">
                  <div className="flex items-center space-x-2 mb-2">
                    <lucide_react_1.CheckCircle className="w-5 h-5 text-accent-500"/>
