...
const tools = [
    {
        ...
        demo: (<div className="bg-gray-50 rounded-lg p-4 border-2 border-dashed border-gray-300 text-center">
        <lucide_react_1.Upload className="w-8 h-8 text-gray-400 mx-auto mb-2"/>
    ...
    },
    {
        ...
        demo: (<div className="bg-white rounded-lg p-4 border border-gray-200">
        <div className="mb-3">
        ...
        <input type="text" placeholder="April 19th, 1775" className="w-full p-2 border border-gray-300 rounded text-sm"/>
    ...
    },
    {
        ...
        demo: (<div className="bg-white rounded-lg p-4 border border-gray-200 text-center">
        <div className="w-12 h-12 bg-primary-100 rounded-full flex items-center justify-center mx-auto mb-2">
          <lucide_react_1.Headphones className="w-6 h-6 text-primary-500"/>
        </div>
...
const StudyTools = () => {
    return (<section id="tools" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-primary-900 to-primary-800 text-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {tools.map((tool, index) => (<div key={index} className="bg-primary-800/50 backdrop-blur-sm rounded-xl p-6 border border-primary-700 card-hover">
