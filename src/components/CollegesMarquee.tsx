      ...
      <div className="marquee-container relative">
        <div className="marquee-content flex space-x-8 items-center">
          {[...colleges, ...colleges, ...colleges].map((college, index) => (
            <div
              key={index}
              className="flex items-center space-x-4 bg-gray-50 rounded-xl px-8 py-4 border border-gray-100 whitespace-nowrap shadow-sm hover:shadow-md transition-shadow duration-300 min-w-max"
            >
